...
import { useFavoritePetList } from '@/hooks/useFavoritePetList'
...
export function FavoritePetListComponent() {
        ...
        headerComponent={
          <div className="w-full flex flex-col my-8 px-6">
            ...
            <div className="w-full flex items-center justify-start">
              <FiltersDialogComponent ref={inViewComponentRef} />
            </div>
          </div>
        }
        loadingComponent={
